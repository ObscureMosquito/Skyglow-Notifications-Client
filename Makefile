...
SkyglowNotificationsDaemon_FILES = main.m KeyManager.m CommonDefinitions.m SettingsUtilities.x
...
SkyglowNotificationsDaemon_PRIVATEFRAMEWORKS = SpringBoardServices

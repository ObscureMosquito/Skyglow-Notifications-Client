...
- (id)init {
    if ((self = [super init])) {
        ...
        _available[SGCapabilityKeepAliveOffload] = NO;
        _available[SGCapabilityCellular]         = YES;

        SGLOGI(SGCapabilityTable, "code=%s platform=ios cf_version=%.2f power_assertion=%d scheduled_wake=%d keepalive_offload=%d cellular=%d",
               ...
               _available[SGCapabilityKeepAliveOffload], _available[SGCapabilityCellular]);
    }
    return self;
}
